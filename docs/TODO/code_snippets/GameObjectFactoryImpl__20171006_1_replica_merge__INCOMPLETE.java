...
import com.replica.engine.AnimationPlayerActivity;
...
import com.replica.engine.ContextParameters;
...
import com.replica.engine.LevelTree;
import com.replica.engine.PlatformComponent;
import com.replica.engine.PlayerComponent;
import com.replica.engine.ScrollerComponent;
...
import com.replica.engine.FadeDrawableComponent;
import com.replica.engine.FixedAnimationComponent;
import com.replica.engine.FrameRateWatcherComponent;
import com.replica.engine.GenericAnimationComponent;
//////// GHOST - BEGIN
//import com.replica.engine.GhostComponent;
//////// GHOST - MID
...
import com.replica.engine.OrbitalMagnetComponent;
...
import com.replica.engine.PopOutComponent;
import com.replica.engine.RenderComponent;
import com.replica.engine.SelectDialogComponent;
import com.replica.engine.SimpleCollisionComponent;
...
import com.replica.engine.TheSourceComponent;
...
//////// GAME - BEGIN
// Set appropriate value (max number of simultaneous objects)
...
//////// GAME - BEGIN
// Components used (must be declared here if used in game!)
            new ComponentClass(AnimationComponentSideImpl.class, 1),
            ...
            new ComponentClass(FixedAnimationComponent.class, 8), // needed/used?
            new ComponentClass(FrameRateWatcherComponent.class, 1),
            new ComponentClass(GenericAnimationComponent.class, 32), // 256?
//////// GHOST - BEGIN
...
//////// GHOST - MID
            ...
            new ComponentClass(ScrollerComponent.class, 8), // needed/used?
...
//////// GAME - END
    ...
    protected boolean isPlayer(int index) {
        boolean ok = false;
//////// GAME - BEGIN
// Add a condition for each object that can be player
...
//keep this? needed?
        ...
        AnimationComponentSideImpl animation =
            (AnimationComponentSideImpl)allocateComponent(AnimationComponentSideImpl.class);
...
// !!!! TODO: add inventory stuff to allow multi-sounds as in original !!!!
// (=> should find a better way to do)
...
//        }
    ...
    public GameObject spawnEnemyBrobot(float positionX, float positionY, boolean flipHorizontal) {
        ...
        HitReactionComponentSingle hitReact
            = (HitReactionComponentSingle)allocateComponent(HitReactionComponentSingle.class);
...
//            basicVulnerabilityVolume.add(new AABoxCollisionVolume(32, 5, 64, 32, HitType.COLLECT));
        ...
        HitReactionComponentSingle hitReact = (HitReactionComponentSingle)allocateComponent(HitReactionComponentSingle.class);
        dynamicCollision.setHitReactionComponent(hitReact);
// !!!! ???? TODO: what flow event? 1? 2? ???? !!!!
        hitReact.setGameEventOnTakeHit(HitType.DIALOG, GameFlowEvent.EVENT_SHOW_DIALOG_CHARACTER, 0);
...
//////// GHOST - MID
    ...
    public GameObject spawnCoin(float positionX, float positionY) {
        ...
        SoundSystem sound = sSystemRegistry.soundSystem;
        if (sound != null) {
            hitReact.setSoundOnTakeHit(HitType.COLLECT, sound.load(R.raw.ding));
        }
    ...
    public GameObject spawnRuby(float positionX, float positionY) {
        ...
        if (staticData == null) {
            ...
            UpdateRecordImpl addRuby = (UpdateRecordImpl)allocateComponent(UpdateRecordImpl.class);
//add field!!!!
            addRuby.mRubyCount = 1;
...
/*
// needed?
// => probably not, as we are using a "DynamicCollisionComponent"?
        HitPlayerComponent hitPlayer = (HitPlayerComponent)allocateComponent(HitPlayerComponent.class);
        hitPlayer.setup(32, hitReact, HitType.COLLECT, false);
*/

// add sound here? (or keep in "anim component"?)
//...
    ...
    public GameObject spawnDiary(float positionX, float positionY) {
        ...
        if (staticData == null) {
            ...
            UpdateRecordImpl addDiary = (UpdateRecordImpl)allocateComponent(UpdateRecordImpl.class);
//add field!!!!
