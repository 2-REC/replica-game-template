...
public class ResultsLevelActivityImpl extends ResultsActivitySpecific {

    @Override
    protected void addContent() {
// example lines:
//  addPercentageResult("results_coins_collected_total", "coins_collected", "coins_total", SoundManager.SOUND_OK);
//  addCounterResult("results_coins_collected_total", "coins_collected", SoundManager.SOUND_OK);
//  addTimerResult("results_coins_collected_total", "coins_collected", SoundManager.SOUND_OK);
...
//////// GAME_SPECIFIC - END
    ...
    protected int getMusic() {
        return MusicManager.MUSIC_END_LEVEL;
    }
